...
const Main = () => {
  return (
    <div id="home" className="w-full h-screen text-center">
      <div className="bg-clip-content bg-[#1acc89] w-full absolute top-[100rem] -z-10 right-[1250rem] h-[600rem] rounded-full blur-[100rem]  dark:bg-[#1be0af]"></div>
      <div className="bg-clip-content bg-[#d795cd] w-full absolute top-[20rem] -z-10 right-[100rem] h-[50rem] rounded-full blur-[700rem]   dark:bg-[#bc4b85]"></div>
